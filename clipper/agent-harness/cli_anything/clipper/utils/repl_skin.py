"""cli-anything REPL Skin for Clipper.

Adapted from the shared cli-anything repl_skin.py with clipper-specific branding.
"""
...
# Clipper accent: vibrant red-orange (video/streaming feel)
_ACCENT = "\033[38;5;203m"
...
class ReplSkin:
    """REPL skin for the Clipper CLI harness."""
    ...
    def __init__(self, version: str = "1.0.0", history_file: str | None = None):
        ...
        if history_file is None:
            ...
            hist_dir = Path.home() / ".cli-anything-clipper"
    ...
    def print_banner(self):
        ...
        name = self._c(_ACCENT + _BOLD, "Clipper")
    ...
    def prompt(self, project_name: str = "", modified: bool = False) -> str:
        parts = []
        if self._color:
        ...
        parts.append(self._c(_ACCENT + _BOLD, "clipper"))

        if project_name:
            mod = "*" if modified else ""
            parts.append(f" {self._c(_DARK_GRAY, '[')}")
            parts.append(self._c(_LIGHT_GRAY, f"{project_name}{mod}"))
            parts.append(self._c(_DARK_GRAY, ']'))

        parts.append(self._c(_GRAY, " ❯ "))
        return "".join(parts)

    def prompt_tokens(self, project_name: str = "", modified: bool = ""):
        tokens = [("class:icon", "◆ "), ("class:software", "clipper")]
        if project_name:
            mod = "*" if modified else ""
            tokens += [
                ("class:bracket", " ["),
                ("class:context", f"{project_name}{mod}"),
                ("class:bracket", "]"),
            ]
    ...
    def get_prompt_style(self):
        ...
        return Style.from_dict({
            "icon": "#5fdfdf bold",
            "software": "#ff5f5f bold",
            "bracket": "#585858",
            "context": "#bcbcbc",
            "arrow": "#808080",
            "completion-menu.completion": "bg:#303030 #bcbcbc",
            "completion-menu.completion.current": "bg:#ff5f5f #000000",
            "auto-suggest": "#585858",
        })
    ...
    def get_input(self, pt_session, project_name: str = "", modified: bool = False) -> str:
        ...
        return input(self.prompt(project_name, modified)).strip()
