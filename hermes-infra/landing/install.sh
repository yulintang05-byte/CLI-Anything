...
#
#  Usage:
#    curl -fsSL https://raw.githubusercontent.com/yulintang05-byte/cli-anything/main/install.sh | bash
#    -- or --
#    bash install.sh
#
...
resolve_version() {
  ...
  local api_url="https://api.github.com/repos/yulintang05-byte/cli-anything/releases/latest"
  local version
...
main() {
  ...
  # 3. Build URLs
  local base_url="https://github.com/yulintang05-byte/cli-anything/releases/download/v${version}"
