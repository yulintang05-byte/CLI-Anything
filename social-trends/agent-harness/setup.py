...
setup(
    ...
    author_email="",
    description=(
        "CLI harness for YouTube & TikTok viral trends — hashtags, music, "
        "account optimization, and converting theme page strategy. "
        "Requires: YouTube Data API v3 key and/or TikTok RapidAPI key."
    ),
    ...
    else "CLI harness for social media trend analysis.",
