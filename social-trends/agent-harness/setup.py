...
setup(
    ...
    version="1.0.0",
    description="CLI harness for viral trend discovery — YouTube & TikTok trends, hashtags, music, account optimization, and theme page strategy",
