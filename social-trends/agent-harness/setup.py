...
setup(
    ...
    author_email="",
    description=(
        "CLI harness for viral social media trend research — "
        "YouTube trending (YouTube Data API v3), TikTok hashtags & sounds (public endpoints), "
        "account optimization, and theme page strategy."
    ),
    ...
    else "CLI harness for social media trend research and account optimization.",
