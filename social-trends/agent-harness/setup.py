...
setup(
    ...
    author_email="",
    description="CLI harness for social media trend scraping (TikTok + YouTube), account optimization, and theme page strategy.",
    ...
    else "CLI harness for social media trend scraping and account optimization.",
