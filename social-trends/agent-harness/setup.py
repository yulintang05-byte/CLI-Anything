...
setup(
    ...
    author_email="",
    description=(
        "CLI harness for social media trend scraping — YouTube & TikTok trending hashtags, "
        "sounds, videos, account optimization, and theme page strategy."
    ),
    long_description=open("README.md", "r", encoding="utf-8").read()
    if __import__("os").path.exists("README.md")
    else "Social Trends CLI harness for YouTube and TikTok.",
