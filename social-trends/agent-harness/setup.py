...
setup(
    ...
    author_email="",
    description=(
        "CLI harness for Social Media Trend Intelligence — scrapes YouTube & TikTok "
        "for viral trends, hashtags, and music; optimizes accounts; guides theme page conversion."
    ),
