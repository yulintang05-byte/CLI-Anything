...
setup(
    ...
    description=(
        ...
        "and theme page strategy. Scrapes TikTok & YouTube for viral trends, "
        "hashtags, and music. No API key required for TikTok; optional YouTube "
        "Data API v3 key for full YouTube data (YOUTUBE_API_KEY)."
    ),
