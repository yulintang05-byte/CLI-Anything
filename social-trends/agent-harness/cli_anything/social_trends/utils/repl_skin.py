"""REPL Skin for Social Trends CLI — viral/social media branding."""
...
# Social media gradient accent — hot pink/fuchsia
...
class ReplSkin:
    ...
    def print_banner(self):
        ...
        tip = f" {self._c(_DARK_GRAY, '   YouTube & TikTok viral trends, account optimization')}"
    ...
    def get_prompt_style(self):
        ...
        return Style.from_dict({
            "icon": "#5fdfdf bold",
            "software": "#ff87ff bold",
            "bracket": "#585858",
            "context": "#bcbcbc",
            "arrow": "#808080",
            "completion-menu.completion": "bg:#303030 #bcbcbc",
            "completion-menu.completion.current": "bg:#ff87ff #000000",
            "auto-suggest": "#585858",
        })
