"""cli-anything REPL Skin — copy of the canonical skin with social-trends accent.

Social Trends accent: hot pink (#ff69b4 / ANSI 205)
"""
...
_ACCENT_COLORS = {
    ...
    "zoom":           "\033[38;5;27m",
    "social_trends":  "\033[38;5;205m",  # hot pink
}
...
class ReplSkin:
    def __init__(self, software: str, version: str = "1.0.0",
        ...
        self.display_name = software.replace("_", " ").replace("-", " ").title()
    ...
    def get_prompt_style(self):
        ...
        return Style.from_dict({
            "icon": "#5fdfdf bold",
            "software": "#ff69b4 bold",   # hot pink for social-trends
            "bracket": "#585858",
            "context": "#bcbcbc",
            "arrow": "#808080",
