...
Adapted from the shared cli-anything repl_skin.py with social-trends branding.
"""
...
# Social Trends accent: vibrant magenta/pink (social media feel)
...
class ReplSkin:
    ...
    def get_prompt_style(self):
        ...
        return Style.from_dict({
            "icon": "#5fdfdf bold",
            "software": "#ff87d7 bold",
            "bracket": "#585858",
            "context": "#bcbcbc",
            "arrow": "#808080",
            "completion-menu.completion": "bg:#303030 #bcbcbc",
            "completion-menu.completion.current": "bg:#ff87d7 #000000",
            "auto-suggest": "#585858",
        })
