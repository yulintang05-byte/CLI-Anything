...
from social_trends.utils.youtube_scraper import fetch_trending_videos as yt_vids, extract_hashtags_from_videos
from social_trends.utils.tiktok_scraper import fetch_trending_hashtags as tt_hashtags
