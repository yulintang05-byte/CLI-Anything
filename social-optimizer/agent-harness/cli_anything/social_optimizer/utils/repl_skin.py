"""cli-anything REPL Skin for SocialOptimizer.

Adapted from the shared cli-anything repl_skin.py with SocialOptimizer branding.
"""
...
# SocialOptimizer accent: electric green (growth/money feel)
_ACCENT = "\033[38;5;118m"
...
class ReplSkin:
    """REPL skin for the SocialOptimizer CLI harness."""
    ...
    def __init__(self, version: str = "1.0.0", history_file: str | None = None):
        ...
        if history_file is None:
            ...
            hist_dir = Path.home() / ".cli-anything-social-optimizer"
    ...
    def print_banner(self):
        ...
        name = self._c(_ACCENT + _BOLD, "SocialOptimizer")
    ...
    def prompt(self, context: str = "", modified: bool = False) -> str:
        ...
        if self._color:
            ...
            parts.append("> ")
        parts.append(self._c(_ACCENT + _BOLD, "social-optimizer"))
        if context:
    ...
    def prompt_tokens(self, context: str = "", modified: bool = False):
        tokens = [("class:icon", "◆ "), ("class:software", "social-optimizer")]
        if context:
    ...
    def get_prompt_style(self):
        ...
        return Style.from_dict({
            "icon": "#5fdfdf bold",
            "software": "#87ff00 bold",
            "bracket": "#585858",
            "context": "#bcbcbc",
            "arrow": "#808080",
            "completion-menu.completion": "bg:#303030 #bcbcbc",
            "completion-menu.completion.current": "bg:#87ff00 #000000",
            "auto-suggest": "#585858",
        })
    ...
    def table(self, headers: list, rows: list, max_col_width: int = 40):
        ...
        for row in rows:
            cells = [self._c(_LIGHT_GRAY, pad(str(row[i]) if i < len(row) else "", col_widths[i])) for i in range(len(col_widths))]
