...
setup(
    ...
    author_email="",
    description="CLI harness for TikTok — Viral trends, hashtags, music discovery & account optimization",
    ...
    else "CLI harness for TikTok viral trends, hashtags, music discovery & account optimization.",
    long_description_content_type="text/markdown",
    url="https://github.com/yourusername/cli-anything-tiktok",
